  ...
  return (
    <SidebarProvider>
      ...
      <div className="min-h-screen flex relative overflow-hidden">
        <Sidebar>
          <SidebarContent
            className={`bg-gradient-to-r from-white/30 to-white/0 backdrop-blur border-r border-white/30 flex flex-col py-6 shadow-lg z-10 transition-all duration-300 ease-in-out ${isExpanded ? 'w-64 items-start px-4' : 'w-20 items-center px-2'
              }`}
          >
            ...
            <div className="mt-auto w-full">
              <button 
                ...
                className="flex items-center justify-center w-full px-4 py-2 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 transition-colors"
              >
...
function App() {
  ...
  // If on login/register pages, show auth
