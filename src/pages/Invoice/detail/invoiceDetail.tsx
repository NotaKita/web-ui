...
const InvoiceDetail = () => {
  ...
  const invoiceItems = [
    {
      description: "maximum price configuration and limiter on category and purchase menu",
      unitCost: 300000,
      qty: 1,
      price: 300000,
    },
    ...
    <div id="invoice-content" className="max-w-4xl mx-auto p-8 bg-white">
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="text-right">
          <h1 className="text-md font-bold text-gray-800 mb-2">INV-20260224-0019X7A9</h1>
